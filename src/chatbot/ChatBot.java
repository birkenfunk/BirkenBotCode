...
public class ChatBot {
    ...
    private static String[] tokenizeSentence(String message) throws IOException {
        try (InputStream modelIn = new FileInputStream("./src/chatbot/models/en-token.bin")) {
    ...
    private static String[] lemmatizeTokens(String[] tokens, String[] posTags) throws IOException {
        try (InputStream modelIn = new FileInputStream("./src/chatbot/models/en-lemmatizer.bin")) {
    ...
    private static String[] detectPOSTags(String[] tokens) throws IOException {
        try (InputStream modelIn = new FileInputStream("./src/chatbot/models/en-pos-maxent.bin")) {
    ...
    private static DoccatModel trainCategorizerModel() throws IOException {
        InputStreamFactory inputStreamFactory = new MarkableFileInputStreamFactory(new File("./src/chatbot/faq-categorizer.txt"));
